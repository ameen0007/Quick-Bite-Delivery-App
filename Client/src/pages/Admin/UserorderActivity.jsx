...
export const UserOrderActivity = () => {
    ...
    const fetchOrders = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:3000/admin/viewActivity`,
          {
            params: { userId },
          }
        );
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    try {
      ...
      console.log(newStatus, "newstatsus");
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8">User Activities</h1>
